...
function AddContainer() {
    ...
    const handleSubmit = async () => {
        if(websiteUrl!=='') {
            try {
                ...
                await axios.post(`${API_URL}/container/add`, { websiteUrl, accounts }, {
                    headers: {
    ...
    return (
        <div className="add-container">
            ...
            <label>Title (e.g.: www.google.com)</label>
            ...
            <div className="accounts-container">
                ...
                {accounts.map((account, index) => (
                    <div key={index} className="account">
                        <label>Email:</label>
                        <input type="email" value={account.email} onChange={(e) => handleAccountChange(index, 'email', e.target.value)} />
